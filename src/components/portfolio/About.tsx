    ...
    <section id="about" className="relative py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-5">
          ...
          >
            <p>
              I am a <span className="text-foreground">Software Developer with 3+ years of experience</span> architecting and optimizing high-performance web applications using <span className="text-foreground">React.js, Next.js, JavaScript, TypeScript, Node.js, and Express</span>.
            </p>
            <p>
              I have delivered production enterprise platforms for <span className="text-foreground">PVR Cinemas, INOX Movies, Aelixar</span>, and multi-tenant loyalty CMS platforms. Passionate about solving complex frontend challenges, reducing load times by <span className="text-foreground">up to 40%</span>, and implementing secure payment integrations with <span className="text-foreground">Stripe & Razorpay</span>.
            </p>
            <p>
              At <span className="text-foreground">Wemonde Pvt Ltd</span>, I develop and maintain 10+ React and Next.js applications. Previously at <span className="text-foreground">Locad Pvt Ltd</span>, I built 10+ responsive frontend interfaces and 15+ RESTful APIs using the MERN stack while driving 95% on-time sprint deliveries.
            </p>
          </motion.div>
            ...
            <div className="rounded-2xl glass-strong p-6">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {["Next.js 15", "React.js", "Stripe", "Razorpay", "FastAPI", "Ollama"].map((t) => (
                  <span key={t} className="rounded-full border border-white/10 bg-white/[0.03] px-2.5 py-1 font-mono text-[11px] text-muted-foreground">{t}</span>
                ))}
              </div>
            </div>
          </motion.div>
        ...
        <div className="mt-16 grid grid-cols-2 gap-4 md:grid-cols-4">
          {stats.map((s, i) => (
            ...
            >
              ...
              <div className="mt-4 text-3xl font-semibold text-gradient sm:text-4xl">{s.value}</div>
