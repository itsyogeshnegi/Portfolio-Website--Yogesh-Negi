        ...
        <div className="mt-10 sm:mt-12 grid gap-3 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((s, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl glass border border-white/10 p-5 sm:p-6 transition hover:border-primary/40"
            >
              ...
              <h3 className="mt-3.5 sm:mt-4 text-base sm:text-lg font-semibold text-foreground">{s.title}</h3>
